...
func printFinalBill() {
	...
	rand.Seed(time.Now().UnixNano())//necessary to produce random integers
	...
	tax := 18 * subTotalBillExcludetaxes / (100)
	grandTotal := subTotalBillExcludetaxes + tax
